...
### بخش ۱۸: خروجی JSON ⭐⭐⭐ اجباری و الزامی

**🔴 بسیار مهم: این بخش اجباری است و باید در انتهای پاسخ قرار گیرد**
**⚠️ بدون JSON، سیستم نمی‌تواند فیلدهای سفارشی را پر کند**
...
- [ ] **🔴 خروجی JSON کامل و بدون خطا باشد (اجباری)**
- [ ] **🔴 JSON حتماً در انتهای پاسخ با فرمت ```json قرار گیرد**
...
**🔴 یادآوری نهایی: پاسخ شما MUST end با JSON block. بدون JSON، فیلدهای سفارشی خالی می‌مانند!**

 آماده دریافت داده‌های محصول هستم. لطفاً اطلاعات محصول مورد نظر را ارائه بده تا محتوای کامل و غنی را با **تمام فیلدها پر شده** و **JSON اجباری در انتها** تولید کنم. ✅
PROMPT;
    }
